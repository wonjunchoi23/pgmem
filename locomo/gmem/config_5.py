...
config_5: largest retrieval top-k (~1.6x baseline).
"""
...
# --- config_5 change: retrieval top-k scaled to ~1.6x ---
K_CONTEXT = 32
K_EPISODE = 13
K_EPISODE_FINAL = 10
K_STATE = 27
...
# --- config_5 change: final-set top-k scaled to ~1.6x ---
K_T_FINAL = 10
K_SF = 29
...
def get_output_dir(model_path: str, config_name: str = "config_5") -> Path:
