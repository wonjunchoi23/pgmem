...
config_4: smaller retrieval top-k (~0.8x baseline).
"""
...
# --- config_4 change: retrieval top-k scaled to ~0.8x ---
K_CONTEXT = 16
K_EPISODE = 6
K_EPISODE_FINAL = 5
K_STATE = 14
...
# --- config_4 change: final-set top-k scaled to ~0.8x ---
K_T_FINAL = 5
K_SF = 14
...
def get_output_dir(model_path: str, config_name: str = "config_4") -> Path:
