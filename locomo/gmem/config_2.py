...
config_2: config_0 baseline with MAX_KEYWORDS / MAX_DOMAIN_LABELS / MIN_DOMAIN_LABELS doubled.
"""
...
TRAIT_MAX_COUNT = 1
# --- config_2 change: keyword / domain-label budgets doubled ---
MAX_KEYWORDS = 14
MAX_DOMAIN_LABELS = 14
MIN_DOMAIN_LABELS = 10

# Seed retrieval top-k (same as config_0)
K_CONTEXT = 20
K_EPISODE = 8
K_EPISODE_FINAL = 6
K_STATE = 17
...
def get_output_dir(model_path: str, config_name: str = "config_2") -> Path:
