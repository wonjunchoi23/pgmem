...
config_6: larger retrieval top-k (~1.3x baseline).
"""
...
# --- config_6 change: retrieval top-k scaled to ~1.3x ---
K_CONTEXT = 26
K_EPISODE = 10
K_EPISODE_FINAL = 8
K_STATE = 22
...
# --- config_6 change: final-set top-k scaled to ~1.3x ---
K_T_FINAL = 8
K_SF = 23
...
def get_output_dir(model_path: str, config_name: str = "config_6") -> Path:
