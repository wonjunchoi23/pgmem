...
config_3: smallest retrieval top-k (~0.6x baseline).
"""
...
# --- config_3 change: retrieval top-k scaled to ~0.6x ---
K_CONTEXT = 12
K_EPISODE = 5
K_EPISODE_FINAL = 4
K_STATE = 10
...
# --- config_3 change: final-set top-k scaled to ~0.6x ---
K_T_FINAL = 4
K_SF = 11
...
def get_output_dir(model_path: str, config_name: str = "config_3") -> Path:
