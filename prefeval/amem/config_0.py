"""
Configuration for A-MEM Experiment on PrefEval (implicit-persona).

Adapted from exp_implexconv_no_response/amem/config_0.py.
...
# At checkpoint k, we have k+1 questions to evaluate; chunk by this size.
QA_BATCH_SIZE = 64
