...
# =============================================================================
# VIRTUAL TIME UTILITIES (ported verbatim from ldagent)
# =============================================================================
...
def compute_virtual_seconds(
    ...
    """
    Compute the virtual time (in seconds from chain start) for a turn.
...
def convert_seconds_to_full_time(seconds: float) -> str:
    """Convert elapsed virtual seconds to 'X years X months X days X hours X minutes'."""
    units = [
        ("years",   31536000),
        ("months",   2592000),
        ("days",       86400),
