"""PGMem experiment runner — batch-capable single entry point.
...
def setup_logging(log_dir: Path) -> logging.Logger:
    ...
    if cfg.LOG_TO_FILE:
        handlers.append(logging.FileHandler(log_dir / f"pgmem_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"))
...
def main():
    ...
    parser = argparse.ArgumentParser(description="PGMem Experiment on ImplexConv")
