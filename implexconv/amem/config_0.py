"""
Configuration for A-MEM Batch Experiment on ImplexConv
"""
...
# Safe default across A6000 (48GB), RTX 4090 (24GB), RTX PRO 6000 (96GB)
# at gpu_memory_utilization=0.5. Increase if VRAM allows.
BATCH_SIZE = 4

# Maximum number of QA prompts to send to vLLM in one generate_batch_raw() call.
# batch_size=4, ~20 QA per session → ~80 QA per batch; 64 keeps chunks manageable.
QA_BATCH_SIZE = 64
...
RETRIEVE_K = 5 # 10 for origin config
