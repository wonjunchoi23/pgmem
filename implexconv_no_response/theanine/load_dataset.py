...
class Turn:
    ...
    def to_memory_content(self) -> str:
        ...
        Follows original A-MEM convention: "Speaker {name} says : {utterance}"
        """
        speaker_name = "User" if self.role == "user" else "Assistant"
...
if __name__ == "__main__":
    ...
    for subset in ("opposed", "supportive"):
        ...
        print(f"\nSession 0 — unique conv_ids: {s.get_unique_conv_ids()}")
        print(f"\nSession 0 — first QA:")
        q = s.qa[0]
