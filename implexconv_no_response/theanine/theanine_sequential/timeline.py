...
# =============================================================================
# PROMPT  (inline; identical to original timeline-refinement.txt)
# =============================================================================

# From timeline-refinement.txt — unchanged (output format changed to JSON)
...
class TimelineRetriever:
    ...
    def retrieve_timeline(self, query: str, memory_graph: MemoryGraph) -> Dict:
        ...
        (most recent first), then samples 1 unique path per retrieved node via
        random.sample — same logic as the original while loop.
        ...
        for node, score in retrieved:
            ...
            # Sample 1 unique path not already in use_timeline — identical to
    ...
    def refine_timeline(self, path_text: str, current_dialogue: str) -> Tuple[str, Dict]:
        """
        ...
        """
        prompt = TIMELINE_REFINEMENT_PROMPT.format(
    ...
    def refine_all(
        ...
        Returns:
            ...
            total_token_info: {"input": ..., "output": ..., "api_calls": ...}
        """
        refined_texts = []
        ...
        for path in use_timelines:
            ...
            refined, token_info = self.refine_timeline(path_text, current_dialogue)
