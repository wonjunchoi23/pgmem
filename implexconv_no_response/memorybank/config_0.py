"""
Configuration for MemoryBank Batch Experiment on ImplexConv
"""
...
# Number of sessions to process together.
BATCH_SIZE = 4

# Maximum number of QA prompts to send in one batch-generate call.
QA_BATCH_SIZE = 64
...
# Number of QA retrieval hits to keep when constructing the original-style
# MemoryBank eval prompt. Retrieval merges dialogue snippets and daily event
# summaries, then keeps the top-k results overall.
RETRIEVE_K = 6
...
TIMING_CONV_ID = 0          # Unused in this batched variant; kept for config compatibility
