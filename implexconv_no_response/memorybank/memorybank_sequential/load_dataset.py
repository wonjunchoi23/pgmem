...
class Turn:
    ...
    def to_memory_content(self) -> str:
        """
        Format for MemoryBank memory storage.
        Returns utterance only (no speaker prefix); speaker labels are added
        externally when building the memory entry content string.
        """
