...
RELEVANCE_MEMORY_NUMBER = 1

# Number of LTM entries fetched by relevance_retrieve during QA
RETRIEVE_K = 1

# ChromaDB distance threshold for relevance retrieval
DIST_THRESHOLD = 1.5
...
MAX_USER_PERSONAS  = 5    # keep latest N user traits   (0 = unlimited)
MAX_AGENT_PERSONAS = 5    # keep latest N agent traits  (0 = unlimited)
