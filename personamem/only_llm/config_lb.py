"""
Configuration for OnlyLLM Lower-Bound Experiment on PersonaMem.

HISTORY_ALL_GIVEN=False with MAX_CONTEXT_MESSAGES=0 means the QA prompt sees
no conversation history — pure LLM prior baseline.
"""
...
# Lower-bound: no conversation history shown to QA prompt.
