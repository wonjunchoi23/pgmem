"""Updater for GraphMem internal calls ②③④⑤."""
...
class GraphUpdater:
    ...
    def _build_trait_call(
        ...
        # episodes, and the previous trait are NOT in the prompt — the trait
    ...
    def _build_5a_call(
        ...
        # id_map layout: [0]=new_trait, [1..]=states, [1+n_states..]=episodes,
        # [1+n_states+n_eps]=prev_trait (if any).
    ...
    def _build_5b_call(
        ...
        # id_map layout: [0]=trait, [1..n_s]=candidate states, [n_s+1..]=candidate episodes.
    ...
    def _build_5d_call(
        ...
        for pair_num, (s_node, e_node) in enumerate(selected_pairs):
            ...
            # Storage canonical for ⑤d is e → s.
