"""
Rolling context cache for GraphMem v5.
"""
...
class ContextCache:
    ...
    def get_prior_pairs(
        ...
        """Up to n most-recent (user, agent, conv_id, turn_id) pairs that are NOT
        the current (conv_id, turn_id). Used by ② state extraction (Change 7).
        Ignores conv_id boundaries: the most recent n prior pairs are returned
        regardless of whether they fall under a different conv_id."""
        if n <= 0:
            return []
        out = [
