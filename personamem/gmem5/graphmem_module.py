...
class GraphMemModule:
    """Top-level GraphMem v5 orchestrator."""
    ...
    def prepare_qa(self, question: str, options: List[str], subset: str = "multichoice") -> PreparedQA:
        ...
        # Note: session_id/conv_id/turn_id store context_index/block_idx/local_msg_idx internally.
        # run_experiment.py remaps these keys to PersonaMem names when building results.
        retrieved_memories = [
            {
