"""
Configuration for Dense Retrieval Batch Experiment on PersonaMem (QA-Only Variant)

Dense retrieval baseline: stores all conversation turns as embeddings (no LLM
calls in Phase 1), retrieves by cosine similarity for QA answering.
"""
...
# =============================================================================
# TIME MODEL  (not used in dense retrieval, kept for consistency)
# =============================================================================
